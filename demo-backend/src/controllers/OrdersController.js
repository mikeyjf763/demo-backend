...
var OrdersController = function () {
    var _classDecorators = [(0, tsoa_1.Route)('orders')];
    ...
    var OrdersController = _classThis = /** @class */ (function () {
        ...
        OrdersController_1.prototype.getOrders = function () {
            return __awaiter(this, void 0, void 0, function () {
                var documents, orders;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, orderSchema_1.OrderModel.find()];
                        case 1:
                            documents = _a.sent();
                            if (!documents) {
                                throw new Error('No orders found');
                            }
                            orders = documents.map(function (doc) { return ({
                                id: doc.id,
                                items: doc.items.map(function (item) { return ({
                                    item: item.item,
        ...
        OrdersController_1.prototype.getOrderById = function (orderId) {
            return __awaiter(this, void 0, void 0, function () {
                var document, order;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, orderSchema_1.OrderModel.findById(orderId)];
                        case 1:
                            document = _a.sent();
                            if (!document) {
                            ...
                            order = {
                                id: document.id,
                                items: document.items.map(function (item) { return ({
                                    item: item.item,
                                    quantity: item.quantity,
                                }); }),
        ...
        OrdersController_1.prototype.createOrder = function (newOrder) {
            return __awaiter(this, void 0, void 0, function () {
                var order;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            order = new orderSchema_1.OrderModel(newOrder);
    ...
    (function () {
        ...
        _getOrders_decorators = [(0, tsoa_1.Get)()];
        _getOrderById_decorators = [(0, tsoa_1.Get)('{orderId}')];
        _createOrder_decorators = [(0, tsoa_1.Post)()];
